using EdPay.Common.MassTransit;
...
// Database services
var dbConnection = builder.Configuration.GetConnectionString("EdPayUserAppDBConnection");
builder.Services.Setup<EdPayDBContext>(dbConnection);
